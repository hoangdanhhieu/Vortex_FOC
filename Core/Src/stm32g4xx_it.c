...
void ADC1_2_IRQHandler(void)
{
  /* USER CODE BEGIN ADC1_2_IRQn 0 */
    if (LL_ADC_IsActiveFlag_JEOS(ADC1)) {
        uint32_t start_count = TIM2->CNT;  // Start timing
        // Clear the JEOS flag
        ...
        adc_isr_us = TIM2->CNT - start_count;  // End timing
    }
...
void USART1_IRQHandler(void)
{
  /* USER CODE BEGIN USART1_IRQn 0 */
    /* UART command I/O replaced by USB CDC — handler intentionally empty */
