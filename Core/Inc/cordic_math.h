...
#define CORDIC_CFG_SINCOS                                                          \
    (LL_CORDIC_FUNCTION_COSINE | LL_CORDIC_PRECISION_6CYCLES | LL_CORDIC_SCALE_0 | \
     LL_CORDIC_NBWRITE_2 | LL_CORDIC_NBREAD_2 | LL_CORDIC_INSIZE_32BITS |          \
     LL_CORDIC_OUTSIZE_32BITS)

#define CORDIC_CFG_ATAN2                                                          \
    (LL_CORDIC_FUNCTION_PHASE | LL_CORDIC_PRECISION_6CYCLES | LL_CORDIC_SCALE_0 | \
     LL_CORDIC_NBWRITE_2 | LL_CORDIC_NBREAD_2 | LL_CORDIC_INSIZE_32BITS |         \
     LL_CORDIC_OUTSIZE_32BITS)

#define CORDIC_CFG_MODULUS                                                          \
    (LL_CORDIC_FUNCTION_MODULUS | LL_CORDIC_PRECISION_6CYCLES | LL_CORDIC_SCALE_0 | \
